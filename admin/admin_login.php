<?php 
    session_start();
      ...
      if(isset($_POST['submit'])){
        ...
        if($username === 'ahtaria' && $password === 'ahtarnur'){
          $_SESSION['admin_login'] = true; header('LOCATION:admin.php'); die();
        } {
...
<style>
body {font-family: Arial, Helvetica, sans-serif;background-color:#e1fafa;}
body.dir {
    direction: rtl;
    text-align: center;
}
...
<dl class="basicInfo-left">
    <dt><label for="uname"><b><?php echo $lang["admin"] ?>:</b></label></dt>
